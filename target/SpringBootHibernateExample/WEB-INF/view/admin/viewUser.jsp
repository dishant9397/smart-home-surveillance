									...
									<table id="datatable" class="table table-bordered">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr>
                                                ...
                                                <td>
                                                <c:if test="${i.loginVO.enabled eq '1'}">
                                                	<a href="updateUser?loginId=${i.loginVO.loginId}&flag=block"><i style="font-size:24px" class="fa">&#xf023;</i></a>
                                                </c:if>
                                                <c:if test="${i.loginVO.enabled eq '0'}">
                                                	<a href="updateUser?loginId=${i.loginVO.loginId}&flag=unblock"><i style="font-size:24px" class="fa">&#xf09c;</i></a>
                                                </c:if>
                                                </td>
                            	            </tr>
                                        </c:forEach>
