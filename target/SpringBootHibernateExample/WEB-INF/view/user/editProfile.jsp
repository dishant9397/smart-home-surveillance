                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        <button type="button" class="btn btn-gradient btn-file">
                                                            ...
                                                            <input type="file" class="btn-secondary" name="profileImage" id="profileImage"/>
                                                        </button>
                                                        <a onclick="clearImage()" class="btn btn-danger fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i> Remove</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
