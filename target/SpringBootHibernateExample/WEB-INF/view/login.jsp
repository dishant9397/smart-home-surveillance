                                    ...
                                    <div class="account-content">
                                        ...
                                        <form class="form-horizontal" action="j_spring_security_check" method="post">
                                            ...
                                            <div class="form-group m-b-20 row">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" type="text" name="username" id="Username" required="required" placeholder="Enter your username">
                                                </div>
                                            </div>

                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    <a href="forgotPassword" class="text-muted pull-right"><small>Forgot your password?</small></a>
                                                    <label for="password">Password<span class="text-danger">*</span></label>
                                                    <input class="form-control" type="password" name="password" required="required" id="Password" placeholder="Enter your password">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row m-t-50">
                                            <div class="col-sm-12 text-center">
                                                <p class="text-muted">Don't have an account? <a href="loadRegister" class="text-dark m-l-5"><b>Sign Up</b></a></p>
                                            </div>
                                        </div>
