                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Complains</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item">Manage Complains</li>
									...
									<table id="datatable" class="table table-bordered">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr>
	                                            ...
	                                            <c:forEach items="${loginList}" var="j">
	                                            	<c:if test="${i.loginVO.loginId eq j.loginId}">
	                                            		<td>${j.username}</td>
	                                            	</c:if>	
	                                            </c:forEach>
    	                                        ...
    	                                        <c:forEach items="${loginList}" var="j">	
    	                                        	<c:if test="${i.loginVO.loginId eq j.loginId}">
    	                                        		<td><a href="<%=request.getContextPath()%>/documents/complain/${j.username}/${i.complainImageName}" target="_blank"><img src="<%=request.getContextPath()%>/documents/complain/${j.username}/${i.complainImageName}" style="max-height: 100px; max-width: 100px"></a></td>
    	                                        	</c:if>
    	                                        </c:forEach>
    	                                    	...
    	                                    	<c:if test="${i.complainStatus eq 'Pending'}">
    	                                    		<td><a href="replyComplain?complainId=${i.complainId}"><i style="font-size:24px" class="fa">&#xf112;</i></a></td>
    	                                    	</c:if>
