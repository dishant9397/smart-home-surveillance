            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
						...
						<div class="alert alert-danger alert-white"><strong>Note!</strong> ${sessionScope.packageEndDateMessage}</div>
                        <div class="row">
                            <div class="col-12">
									...
									<table id="datatable" class="table table-bordered">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr>
                	                            ...
                	                            <td><a href="openPurchasePackage?id=${i.packageId}"><i style="font-size:24px" class="fa">&#xf07a;</i></a></td>
                            	            </tr>
                                        </c:forEach>
                                       </tbody>
                                    </table>			
